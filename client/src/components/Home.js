  ...
  return (
    <>
      ...
      <section className="home" id="home">
        ...
        <h4 data-speed="-2" className="home-paralla">
          Travel hassle-free
        </h4>
        <img
          data-speed="5"
          ...
          alt=""
        />
        <NavLink className="btn" to="/exploreSaleCars">
        ...
        <div className="box-container">
          <div className="box">
            ...
            <button className="btn">
              <NavLink to="/buycar">Check Cars</NavLink>
            </button>
          </div>
          ...
          <div className="box">
            ...
            <button className="btn">
              <NavLink to="/rentcar">Check Cars</NavLink>
            </button>
          </div>
          ...
          <div className="box">
            ...
            <button className="btn">
              <NavLink to="/saleyourcar">Check Cars</NavLink>
            </button>
          </div>
        </div>
      </section>
      ...
      <section className="footer" id="footer">
        <div className="box-container">
          <div className="box">
            ...
            <a href="#">
              {' '}
              <i className="fas fa-map-marker-alt"></i> Chittagong{' '}
            </a>
            <a href="#">
              {' '}
              <i className="fas fa-map-marker-alt"></i> Barisal{' '}
            </a>
            <a href="#">
              {' '}
              <i className="fas fa-map-marker-alt"></i> Rajshahi{' '}
            </a>
            <a href="#">
              {' '}
              <i className="fas fa-map-marker-alt"></i> Cox's Bazar{' '}
            </a>
          </div>
          ...
          <div className="box">
            ...
            <a href="#">
              {' '}
              <i className="fas fa-phone"></i> +8801610698192{' '}
            </a>
            <a href="#">
              {' '}
              <i className="fas fa-phone"></i> +880-234-785{' '}
            </a>
            <a href="#">
              {' '}
            ...
            <a href="#">
              {' '}
              <i className="fas fa-map-marker-alt"></i> Dhaka, Bangladesh - 1229
            </a>
          </div>

          <div className="box">
            <h3>Contact Info</h3>
            <a href="https://www.facebook.com/maymuna.rukaiya">
              {' '}
        ...
        <div className="credit">
          {' '}
          Created by Maymuna Rukaiya || All Rights Reserved{' '}
        </div>
      </section>
    </>
  );
