...
const Salecarreports = () => {
  ...
  const {adminState, dispatchadmin} = useContext(AdminContext)
    ...
    const getsalecarincome = async () =>{
        try {
            const res = await fetch ('/getsalecarincome', {
                method: 'GET',
            });
    ...
    <nav>
      ...
      <div className="profile-details">
        ...
        <div className = "salecartableDiv">
            ...
            <h1 className="heading"><span>Sold Cars Income Report</span></h1>
